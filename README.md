...
*   **Data Collection:** 
    *   Post-experiment questionnaires and semi-structured interviews to assess subjective user impact (e.g., confidence, cognitive load, spatial awareness).
...
**Key Findings:**
*   **Success Rate:** All participants successfully escaped the maze.
